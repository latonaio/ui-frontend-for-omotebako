    ...
    return (
      <Layout navType='reservations'>
        ...
        {phase === "RESERVATION_GUEST" && (
          <>
            <StatusBar2 icon='calendar' text='予約状況を照会しています、お客さま情報を表示しています。' />
            <div className={s.detailPage}>
              ...
              <div className={s.right}>
                <div className={s.name}>
                  ...
                  >
                    {customerEnterInfo.name} {customerEnterInfo.name_kana} 様
                    </div>
                ...
                <div>
                  ...
                  >{customerEnterInfo.reservation_holder} {customerEnterInfo.reservation_holder_kana} 様</span>
